...
begin
  ...
  set
    points_balance = cp.points_balance + v_points,
    total_spent_eur = cp.total_spent_eur + p_eur_amount
  where cp.organization_id = p_organization_id
    and cp.external_customer_id = p_external_customer_id
  returning cp.id, cp.points_balance, cp.total_spent_eur
